...
- The top nav (`src/app/(app)/layout.tsx`) now has 6 links plus name/sign-out (Dashboard, Deals, Finances, Clients, Documents, Account). This is the threshold flagged a few features back — genuinely worth a sidebar redesign before Phase 2's broker dashboard adds a 7th.
